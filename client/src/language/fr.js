export const fr = {
  ...
  footer: {
    ...
    linkSocial: "https://www.canada.ca/fr/sociaux.html",
    mobile: "Applications mobiles",
    linkMobile: "https://www.canada.ca/fr/mobile.html",
    about: "À propos de Canada.ca",
    linkAbout: "https://www.canada.ca/fr/gouvernement/a-propos.html",
    terms: "Avis",
    linkTerms: "https://www.canada.ca/fr/transparence/avis.html",
    privacy: "Confidentialité",
    linkPrivacy: "https://www.canada.ca/fr/transparence/confidentialite.html",
    dts: "Solutions technologiques numériques",
    linkDTS: "https://home.dts-stn.com/fr",
  ...
  contact: {
    ...
    // Options
    textType: "Veuillez sélectionner un type",
    Federal: "Fédéral",
    External: "Externe",
    ...
    notProfit:
      "Organisations à but non lucratif, Gouvernements municipaux, Organisations indigènes",
    forProfit: "Organisations à but lucratif",
    provGovCorp:
      "Gouvernement provincial et territorial, Agences d'institutions et sociétés d'État",
    fedGovDept:
      "Ministères du gouvernement fédéral, Agences et autres entités financées par des fonds publics",
    //
  ...
  engagement: {
    ...
    tags: "Mots clés",
    tagLabel:
      "Appuyez sur Entrée ou cliquez sur + pour ajouter de nouvelles balises (Maximum 3 balises)",
  ...
  engagementValidation: {
    ...
    duplicateTags:
      "La balise existe déjà, veuillez entrer un autre nom de balise",
    duplicateContacts:
      "Le contact existe déjà, veuillez sélectionner un autre nom de contact",
